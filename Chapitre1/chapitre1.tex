...
Ces écosystèmes ont, comme leur nom peut le laisser penser, un lien étroit avec l'eau.
Ainsi outre les tourbières, les lacs, les deltas, les mangroves en font également partie.
Les tourbières représentent 50 à 70 \% des zones humides (francez2000, wise use of peatland), s'étendant sur plus de 4000000 de km$^{2}$ (Lappalainen).
