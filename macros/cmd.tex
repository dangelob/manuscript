...
% µmol e- m2 s1
\DeclareSIUnit{\umle}{\micro\mole e^{-} m^{-2} s^{-1}}
% µmolm2s1
...
% mg/L
\DeclareSIUnit{\mgl}{\milli\gram\per\litre}
...
\definecolor{pdbleu}{RGB}{38,93,171}%
\definecolor{pdrouge}{RGB}{203,32,39}%
% Flèche tableau chap 4
\newcommand{\decarrow}{\textcolor{pdbleu}{$\searrow$}}
\newcommand{\incarrow}{\textcolor{pdrouge}{$\nearrow$}}
