...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{.98\textwidth} % "0.45" donne ici la largeur de l'image
        ...
        \caption{sphagnum eriophorum}\label{fig:sphg_erio}
    \end{subfigure}
...
%        \centering \includegraphics[trim=0cm 0cm 0cm 0cm, clip=true, width=\textwidth]{chap2/molinia_caerulea_c.jpg}
        ...
        \caption{erica tetralix}\label{fig:erica}
    \end{subfigure}
...
%        \centering \includegraphics[trim=0cm 0cm 0cm 0cm, clip=true, width=\textwidth]{chap2/erica_tetralix_c.jpg}
        \caption{molinia caerulea}\label{fig:mol}
    \end{subfigure}
%    ~
...
%    \end{subfigure}
    \caption{Végétations présente sur le site de La Guette}\label{fig:veg}
\end{figure}
