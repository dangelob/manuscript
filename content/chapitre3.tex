...
Malgré ces différences, on observe une grande proximité dans les valeurs des flux interpolés sur les 2 années, quelque soit le modèle, avec un écart maximum de \SI{25}{\gcma}.
...
\citep{jacobs2007} estime des valeurs de PPB comprises entre 400 et \SI{2000}{\gcma} avec une moyenne de \SI{1300}{\gcma} dans des prairies tourbeuses hollandaise.
...
% % Apport IV
L'apport de l'indice de végétation dans l'estimation de la PPB est important lors de la phase de calibration (observation faite également par \citep{bortoluzzi2006}).
