...
À l'intérieur de cette surface ont été installé de façon permanente un piézomètre et une embase permettant la mesure des flux de gaz (Les embases sont décrites dans le chapitre~\ref{ch:ch2}, partie~\ref{subsec:ss_mes_co2}).
...
\subsubsection{Variables élaborées}
...
\begin{figure}
\centering
\includegraphics[width=1.15\textwidth, center]{chap3/T_mean_evolution}
...
\begin{figure}
\centering
\includegraphics[width=1.15\textwidth, center]{chap3/cond_mean_evolution}
\includegraphics[width=1.15\textwidth, center]{chap3/pH_mean_evolution}
\includegraphics[width=1.15\textwidth, center]{chap3/NPOC_mean_evolution}
...
\begin{figure}
	\centering
	\includegraphics[width=1.15\textwidth, center]{chap3/GPP_evolution_avg}
	\includegraphics[width=1.15\textwidth, center]{chap3/ER_evolution_avg}
	\includegraphics[width=1.15\textwidth, center]{chap3/NEE_evolution_avg}
...
\begin{figure}
\centering
\includegraphics[width=1.15\textwidth, center]{chap3/BdC_GPP_interp}
...
\begin{figure}
\centering
\includegraphics[width=1.15\textwidth, center]{chap3/BdC_ER_interp}
...
\begin{figure}
\centering
\includegraphics[width=1.15\textwidth, center]{chap3/CH4_BdCitp_IVcov}
...
Une seconde hypothèse, qui n'exclue par la première, est la composition végétale de ces sites. 
La tourbière de La Guette est envahie par une végétation vasculaire, notamment herbacée.
Elle est, par conséquent, plus proche d'une prairie tourbeuse que d'une tourbière boréale.
...
Sur des écosystèmes similiaires, au Danemark, \citep{gorres2014} trouve des valeurs de PPB plus importantes encore, entre 1555 et \SI{2590}{\gcma}, mais avec des niveaux de nappe plus faible (< \SI{-30}{\centi\metre}).
Il semble cohérent que les valeurs de la PPB de la tourbières de La Guette soit plus forte que celle mesurées dans des tourbières boréales, et moins importantes que celle mesurées dans des tourbières utilisées comme prairie permanente.
En effet par sa position géographique, elle subit un climat moins dur que les tourbières boréales, notamment avec des hivers moins longs et froids.
De plus la végétation vasculaire qui l'envahie doit favoriser une PPB plus élevée.
...
\subsection{Estimations du bilan net de l'écosystème}
