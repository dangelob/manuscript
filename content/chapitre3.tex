...
Les analyses de COD ont été faite en utilisant la technique dite NPOC (\textit{Non Purgeable Organic Carbon}) dans laquelle le carbone présent dans l'échantillon est transformé en \coo par l'ajout d'un acide (\textbf{À vérifier}).
...
\subsection{Variabilité saisonnière du bilan de C gazeux}
...
\subsection{Estimation des flux de carbone organique dissout}
...
Les concentrations en COD mesurées à l'exutoire sont très proche pour les deux années \num{18.6} et \SI{18.3}{\mgl} respectivement.
