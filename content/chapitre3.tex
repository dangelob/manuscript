...
L'utilisation de ces profondeurs est justifiée par le fait que dans la tourbe, la respiration du sol est la plus importante au dessus du niveau de l'eau et donc en surface \citep{Luo200661}. %\textbf{production CO2 ? profils ?}
...
%Ceci étant, il faut également noter les valeurs importantes de l'écart type particulièrement en juin et en août.
...
%Le groupe Bryophytes a, pour les deux modèles, un flux annuel plus faible que le flux calculé à l'échelle de l'écosystème.
%Le groupe Chaméphyte ligneux est, quant à lui, le plus proche des flux « écosystèmes » tandis que le groupe Hétérogène est au dessus.
%L'estimation de la RE du groupe Graminoïde est supérieure a celle estimée à l'échelle de l'écosystème pour RE-1 et inférieure pour RE-3.
%La RE du groupe Bryophytes est inférieur aux autres groupes que ce soit pour RE-1 ou RE-3. 
%Entre RE-1 et RE-3 les estimations du groupe Graminoïde diminue de façon importante (\num{-338}) alors qu'elles sont relativement similaire ($\pm$\num{50}) pour les autres groupes.
...
%On constante que du point de vue de l'ENE les groupes Bryophytes et Hétérogène sont relativement proche, et que le groupe Chaméphyte ligneux est du même ordre de grandeur bien qu'avec une ENE un peu plus élevée.
%Le groupe Graminoïde est le seul groupe présentant une ENE positive, du même ordre de grandeur que les précédentes en valeur absolue.
%Dans le détail, la RE est la plus forte, supérieure à \SI{1200}{\gcma}, dans les groupes Hétérogène et Chaméphyte ligneux.
%Elle est plus faible dans les groupes Bryophytes et Graminoïde (environ \SI{1000}{\gcma}).
%Pour la PPB, la valeur la plus faible est dans le groupe Bryophytes et la plus forte dans le groupe Graminoïde avec plus de \SI{1300}{\gcma}, soit une différence de plus de \SI{600}{\gcma}.
%Les groupes Hétérogène et Chaméphyte ligneux sont relativement proches avec des valeurs intermédiaires avoisinant \SI{1000}{\gcma}.
...
%année & Bryophytes & Hétérogène & Graminoïde & Chaméphyte ligneux & \\ \cmidrule(r){1-5} %\midrule
...
% il ne semble pas y avoir de gradient spatial des flux que ce soit pour la PPB ou la RE (Annexe~\ref{sec:carte_flux}).
...
%Le bilan du groupe Graminoïde s'expliquerait donc par le niveau élevé de la nappe d'eau limitant la respiration hétérotrophe tout en ne limitant pas, ou moins la PPB.
