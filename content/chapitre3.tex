...
Quel que soit le bilan considéré, la tourbière de La Guette est soit à l'équilibre soit une source de carbone.
...
Les estimations utilisant PPB-1 sont plus proches les unes des autres et semblent indiquer que la tourbière est une légère source de carbone ou s'approche d'un équilibre.
...
La présence de végétaux vasculaires qui en transportant le \chh dans l'atmosphère diminuent la concentration en \chh dans le sol tendraient cependant à diminuer ce phénomène en minimisant l'augmentation de la concentration en \chh dans la porosité du sol \citep{chanton2005}.


\subsubsection{Représentativité locale et limitation du bilan}

Si l'on excepte la placette n°5, les estimations de la RE à l'échelle de l'écosystème permettent de représenter les placettes de façon individuelle avec une NRMSE comprise entre 20 et \SI{100}{\percent} pour RE-1 et entre 20 et \SI{80}{\percent} pour RE-3.
La majorité des placettes à une NRMSE d'environ \SI{55}{\percent} pour RE-1 et d'environ \SI{40}{\percent} pour RE-3 (Figure~\ref{fig:repr_loc}, RE-1 et RE-3).
Ces observations permettent de soutenir l'intérêt d'inclure l'indice de végétation dans la modélisation de la RE.
Pour la PPB, toujours à l'exception de la placette n°5, les estimation à l'échelle de l'écosystème permettent de représenter les placettes avec une NRMSE comprise entre 20 et \SI{90}{\percent} pour PPB-1 et entre 30 et \SI{100}{\percent} pour PPB-2.
