...
En outre ces écosystèmes ont une diversité forte que ce soit dans leur fonctionnement naturel ou les perturbations qu'elles subissent.
Malgré cela il existe relativement peu d'estimations de leur bilan de carbone prenant en compte à la fois la contribution du \coo, du \chh et du COD.
...
Les estimations du bilan de carbone de tourbières situées plus au sud, notamment en Europe, sont plus rares : une tourbière du Jura français par exemple \citep{bortoluzzi2006a}. 
De nombreuses études ont été faites sur les tourbières au Canada, mais le climat y est assez différent, avec notamment des hivers plus froids pour des latitudes équivalentes.
...
L'étude de ces écosystèmes présent à la limite sud de leur extension est importante.
...
Plus spécifiquement le site d'étude (la tourbière de La Guette) est représentative d'une grande partie des tourbières dans les perturbations qu'elle subie : son drainage et son envahissement par une végétation vasculaire (Les caractéristiques du site sont détaillées dans le chapitre~\ref{ch:ch2}).
Le \textbf{premier objectif} de ce chapitre est donc d'\textbf{établir le bilan de C} de la tourbière de La Guette, afin de mieux comprendre comme fonctionne cet écosystème mais également comme il se situe par rapport à des écosystèmes établi dans des zones a priori plus favorables.
...
Par exemple le niveau de la nappe peut, à cause de variation micro-topographique, être plus ou moins élevé, immerger la surface du sol avec des zones d'eau libre ou au contraire être quelques dizaines de centimètres sous la surface du sol.
