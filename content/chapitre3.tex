...
Le modèle RE-2, proche de RE-3 n'a pas été calibré quant au modèle PPB-1 sa calibration par placette ne converge pas pour un grand nombre d'entre elles, il a donc été laissé de côté.
