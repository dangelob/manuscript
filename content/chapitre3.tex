...
La température a été choisie comme base de départ à la construction des modèles de RE et PPBsat, car (i) c'est le facteur de contrôle le plus souvent invoqué et (ii) les corrélations avec les flux étaient les plus forte.
