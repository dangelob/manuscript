...
\begin{equation}\label{eq:juneT5}
...
\caption{PPBsat modèles T5 utilisant l'équation~\ref{eq:juneT5}}
...
\caption{Résidus de l'équation~\ref{eq:juneT5} en fonction de l'indice de végétation}
...
\caption{PPBsat modèles T5 utilisant l'équation~\ref{eq:juneT5IV}}
...
\begin{equation}\label{eq:juneT5IV}
...
\begin{table}
\centering
\caption{Sensibilité relative (en \%) du bilan de \coo en réponse à une variation de $\pm$\SI{10}{\percent} de chacun des paramètres des modèles.}
...
& a & 0.34 & +10 & -10 \\
& b & 0.10 & +29 & -22 \\ [+1ex]
GPP & \multicolumn{4}{l}{équation~\ref{eq:juneT5} et \ref{eq:PPB_bubier}} \\
& a & 26.23 & +9 & -10 \\
& b & 53.68 & -36 & 44 \\
& c & 27.21 & +22 & -23 \\
& i & 1.84 & 0 & -1 \\ [+1ex]
GPP & \multicolumn{4}{l}{équation~\ref{eq:juneT5IV} et \ref{eq:PPB_bubier}} \\ 
& a & 33.66 & -1 & -17 \\
& b & 42.45 & -27 & 8 \\
& c & 25.77 & +1 & -18 \\
& i & 0.33 & -8 & -10 \\
