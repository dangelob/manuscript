...
L'interpolation des flux de PPB montrent une variabilité saisonnière proche de celle mesurée sur le terrain (Figure~\ref{fig:BdC_GPP_interp}-a). 
Les valeurs les plus forte mesurées ne semblent pas atteinte par le modèle PPB-2.
Pour la RE, l'interpolation suit également les variations saisonnière mesurée mensuellement (Figure~\ref{fig:BdC_ER_interp}-b).
