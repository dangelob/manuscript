...
\subsection{Variabilité saisonnière des flux à l'échelle de l'écosystème}
...
\subsubsection{Les flux annuels}
...
C'est d'ailleurs dans ces gammes de valeurs, inférieures à celles relevées sur la tourbière de La Guette, que sont comprises la majorité des estimations (Figure~).
...
\subsubsection{Estimations du bilan net de l'écosystème}
...
\subsection{Variabilité spatiale des flux et du bilan de \coo}

\subsubsection{Variabilité du recouvrement végétal}
