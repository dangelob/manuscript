...
L'équation~\ref{eq:PPB_bubier} a été proposée par bubier1998 et tandis que l'équation~\ref{eq:PPB_sig}, plus rarement utilisée a été introduite par \textbf{XXXX}.
...
Enfin ces modèles ont été évalués\footnote{On ne parle pas ici de validation car les données utilisées bien qu'indépendante du jeu de données utilisé pour la calibration n'ont pas été acquise suivant un protocole identique, notamment au niveau de la répartition des embases sur le site.} sur des données issues d'une autre expérimentation.
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chap3/GPP_Ta_mdl_mesmod}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chap3/GPP_Ta_mdl_res}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chap3/GPP_TaIV_mdl_mesmod}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chap3/ER_Ta_mdl_mesmod}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chap3/ER_Ta_mdl_res}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chap3/ENE_TaIV_Ta_mdl}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{chap3/ENE_BdCitp_TaIVcov_Ta}
