...
La température de l'air utilisée dans un modèle exponentiel permet d'expliquer une grande partie des variations de la respiration de l'écosystème (Figure~\ref{fig:ER_Ta_mdl}).
Les résidus de cette équation semble répartis de façon non-biaisée (pas de tendance dans le nuage de point). \textbf{figtodo}
