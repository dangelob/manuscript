...
En effet de nombreuses études ont relié les émissions de \coo au niveau de la nappe d'eau.
Cependant, aucun consensus n'a encore été atteint.
La majorité des études montrent qu'une tourbière dont le niveau de la nappe est abaissé, soit par un drainage, soit par une sécheresse, a un ENE plus faible.
...
Cette observation va dans le même sens que \citet{lund2012} qui observent en 2008 une baisse de l'ENE dans une tourbière à sphaignes située au sud de la Suède.
...
\citet{strack2009} ont ainsi observé qu'une réhumectation graduelle alimentée par le bas de la colonne de sol conduisait à une baisse de la RE, tandis qu'une hausse rapide par le haut de la colonne, simulant un événement pluvieux, conduisait à un pic de RE.
...
Cet effet étant peu ou pas visible \textit{in-situ} (cf chapitre~\ref{ch:ch3}).
...
\caption{Dispositif expérimental : les mésocosmes sont installés dans un trou creusé dans le sol. Ils sont isolés de ce dernier par une bâche imperméable et, pour l'expérimentation B, des sondes de température reliées à une station météorologique sont installées à différentes profondeurs.}
\label{fig:mesocarte}
\end{figure}
...
L'étude des cycles de dessiccation/ré-humectation est effectuée sur des mésocosmes cylindriques (\SI{30}{\centi\metre} de diamètre et de profondeur), prélevés dans la tourbière de La Guette et installés en extérieur.
...
L'expérimentation a été réalisée durant l'été 2013 avec un seul cycle long, on s'y référera par la suite comme l'expérimentation A.
...
Cette expérimentation a été effectuée dans le cadre des stages de Master de Tianyi Ji, de l'Université de Fudan en Chine qui s'est occupé de l'acquisition des données \coo, et de Sarah Williams qui a réalisée les mesures de \chh. 

Pour les deux expérimentations, les variables explicatives sont la température de l'air, du sol (à \SI{-5}{\centi\metre}), le niveau de nappe d'eau, et la teneur en eau du sol. 
...
Pour l'expérimentation A les mesures ont été faites en insérant verticalement la sonde d'une dizaine de centimètre dans le mésocosme.
La mesure est donc une intégration de la teneur en eau sur \SI{10}{\centi\metre}.
En revanche pour l'expérimentation B, la sonde à été insérée horizontalement sur un côté des mésocosmes à une profondeur fixe (\num{-5}, \num{-10} et \SI{-20}{\centi\metre}).
...
Enfin ils sont transportés au laboratoire ou ils sont installés en extérieur et saturés en eau (eau prélevée dans la tourbière), afin que leurs conditions hydrologiques de départ soient les plus proches possibles (Figure~\ref{fig:mesocarte}).
...
Le 17 avril 2014, six nouveaux mésocosmes ont été prélevés dans la tourbières de La Guette et installés près du laboratoire, en suivant le même protocole que pour l'expérimentation A.
...
Contrairement à l'expérimentation A, le niveau de nappe du groupe « Contrôle » de l'expérimentation B reste relativement constant pendant l'ensemble de la période de mesures (Figure~\ref{fig:HMty}--A).
...
Lors de cette expérimentation et compte tenu de la durée de chaque cycle, le nombre de points par cycle est moins important que pour l'expérimentation A.
...
Pour le \chh, que ce soit pour l'expérimentation A ou B, aucune tendance ne semble se dégager vis à vis du niveau de la nappe (Figure~\ref{fig:hm_wtl}--A et B).
...
En revanche, pour l'expérimentation B, l'ENE moyen est de \SI{2.71}{\uml} ce qui est proche de celui mesuré sur le terrain : \SI{2.93}{\uml}.
...
Le fait que les groupes « Dessiccation », quelque soit la phase et l'expérimentation, aient des flux de \chh plus faibles que les groupes « Contrôle » peut s'expliquer par le fait que la communauté des méthanogènes n'est pas (expérimentation B) ou moins (expérimentation A) perturbé par les dessications dans les groupes « Contrôle » par rapport aux groupe « Dessiccation ».
...
L'effet de la baisse du niveau de la nappe sur la PPB semble être au contraire limité que ce soit pour l'expérimentation A ou B.
