...
%Enfin le dernier cycle fut mesuré du 4 au 11 aout pour la dessication et du 12 au 14 aout pour la réhumectation (Tableau~\ref{table:recap_DR}).
...
\begin{table}
\centering
\caption{Récapitulatif des différentes phases de dessication/réhumectations pour les deux expérimentations. La colonne code phase correspond à la première lettre de la phase (D pour dessication et R pour réhumectation) suivi d'un numéro représentant l'ordre du cycle }
...
Dans le même temps le niveau de nappe du groupe Dessication diminue (\num{-10} à \SI{-15}{\centi\metre}) avec la teneur en eau du sol (87 à \SI{53}{\percent}).
Entre les campagnes 9 à 15 le niveau de nappe diminue pour les deux groupes.
De \num{-7} à \num{-22} et de \num{-18} à \SI{-25}{\centi\metre} respectivement pour les groupes Contrôle et Dessication.
Les groupes Contrôle et Dessication se retrouve également proche en termes de teneur en eau du sol : 41 et \SI{43}{\percent} respectivement.

À l'inverse de la dessication, la réhumectation semble s'effectuer de façon similaire pour les deux groupes.
La réhumectation commence par une augmentation du niveau de la nappe importante des campagnes 15 à 18 : il passe de \num{-22} à \SI{-4}{\centi\metre} pour le groupe Contrôle et de \num{-25} à \SI{-5}{\centi\metre} pour le groupe Dessication.
Dans ce même temps la teneur en eau du sol varie peu, de 43 à 57 et de 41 à \SI{56}{\percent} respectivement pour les groupes Contrôle et Dessication.
...
Cependant la teneur en eau du sol continue d'augmenter passant de 57 à \SI{90}{\percent} pour le groupe Contrôle et de 56 à \SI{86}{\percent} pour le groupe Dessication.
Au delà de la campagne 20 le comportement des groupes divergent à nouveau.
Le groupe Contrôle semble reprendre le même chemin de dessication à l'exception d'un point.
Ce point, la campagne 23 et liée à une baisse brusque du niveau de la nappe (\SI{-18}{\centi\metre}) et semble d'avantage sur le « chemin » du groupe Dessication (Figure~\ref{fig:wtlSWC}).
Le groupe dessication quant à lui suit un chemin proche de sa première phase de dessication même si la teneur en eau du sol diminue moins rapidement par rapport au niveau de la nappe que précédemment.
