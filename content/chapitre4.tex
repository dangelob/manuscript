...
Au delà de la campagne n°20 le comportement des groupes divergent à nouveau.
Le groupe « Contrôle » semble reprendre le même chemin de dessiccation à l'exception d'un point.
Ce point, (campagne n°23) et liée à une baisse brusque du niveau de la nappe (\SI{-18}{\centi\metre}) et semble d'avantage sur le « chemin » du groupe « Dessiccation ».
...
Ils expliquent cette observation par le fait qu'une baisse du niveau de la nappe peut permettre une libération du méthane accumulée dans une porosité précédemment scellée par la saturation en eau.
...
Autrement dit, dans cette gamme de variation du niveau de la nappe d'eau, les variations observées seraient davantages liées à des effets de pression de l'eau, ouvrant ou fermant une partie de la porosité du sol et permettant ou empêchant le transport de \chh.
Cette hypothèse permet d'expliquer le pic de \chh observé lors du passage de R1 à D2 (expérimentation II, groupe « Dessiccation »).
La baisse d'émission de \chh observée entre D3 et R3 s'expliquerait alors par un blocage du transport.

Le fait que les groupes « Dessiccation », quelque soit la phase et l'expérimentation, aient des flux de \chh plus faibles que les groupes « Contrôle » peut s'expliquer par le fait que les micro-organismes méthanogènes soient peu perturbés par les dessications dans les groupes « Contrôle » par rapport aux groupe « Dessiccation ».
