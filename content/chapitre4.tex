...
Afin de séparer les effets de la température et ceux du niveau de la nappe, les résidus des équations $RE=a*exp(b*Tair)$ pour la RE et $\chh=a*exp(b*Tair)$ pour le \chh ont été mis en relation avec le niveau de la nappe (Figure~\ref{fig:HM_res}).
