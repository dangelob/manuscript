...
\begin{itemize}
\item Dans un premier temps, un suivi de la tourbière de La Guette a été mis en place, sur deux années, permettant d'évaluer les flux de GES (\coo et \chh) et d'étudier leurs variations saisonnières et spatiales sur l'ensemble de l'écosystème. Ces estimations de flux ont ensuite pu être utilisées afin d'estimer le bilan de carbone de la tourbière.
