...
La précision et la fréquence importante de ses mesures lui permirent de voir pour la première fois les variations journalières et saisonnières des concentrations en \coo atmosphérique, mais également à plus long terme leur tendance haussière \cite{harris2010}.
...
Ce constat a probablement joué un rôle considérable dans la prise de conscience, par la communauté scientifique, de l'importance et de l'intérêt de l'étude du changement climatique et plus largement des changements globaux.\index{changements globaux}
...
Tout d'abord en caractérisant la variabilité spatiale et temporelle des flux de carbone à travers l'établissement de bilans de carbone.
...
Pour atteindre ces objectifs, nos travaux ont été articulés autour de trois axes principaux :
...
\item Le cinquième chapitre
\item Enfin la dernière partie du document se veut une synthèse des travaux réalisés, de leur résultats, suivie d'une ouverture vers les perspectives que ce travail apporte.
