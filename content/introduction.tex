...
Aujourd'hui, que ce soit pour le comprendre, le caractériser ou bien le prédire, de nombreux \todo[inline]{Combien ? cf fact sheet IPCC} scientifiques dans un grand nombre de disciplines, travaillent directement ou indirectement sur les changements globaux.
...
\todo[inline]{Pas d'entrée "journal" pour Post1982}
...
Pour atteindre ces objectifs, nos travaux ont été articulés autour de trois volets \todo[inline]{volet... t'as pas mieux ? Branche ? -\_-"} principaux :
