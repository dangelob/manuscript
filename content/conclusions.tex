...
Les estimations des flux de la tourbière de La Guette par les modèles du chapitre~\ref{ch:ch3} peuvent être comparées aux données acquises sur le même site lors d'autres expérimentations.
