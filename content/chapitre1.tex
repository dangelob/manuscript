...
\end{pdef}
Ce processus de formation est appelé la tourbification\index{tourbification} ou turfigénèse.
Le seuil de \SI{30}{\percent}, souvent utilisé pour rapprocher sa définition de celle d'un sol organique (histosol) au sens large.
Cependant ce que les écologues considère comme de la tourbe contient généralement plus de \SI{80}{\percent} de matières organiques \citep{rydin2013b}.
...
L'épaisseur de tourbe accolée à cette définition peut varier selon le pays, ainsi elle est établie à \SI{40}{\cm} au Canada \citep{nationalwetlandsworkinggroup1997}
\begin{pdef}
...
Les concepts derrières ces deux définitions se chevauchent mais ne sont pas complètement similaires : une tourbière drainée peut avoir plus de \SI{30}{cm} de tourbe et ne plus être active.
...
\end{tabular}
\end{table}
\textbf{Définir matières organiques...}
