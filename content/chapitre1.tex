...
\subsection{Les facteurs majeurs contrôlant les processus ?(flux)}
...
La végétation également que ce soit de façon directe ou indirecte.
...
\begin{figure}
\centering
\includegraphics[width=.5\textwidth]{chap1/PAR_photo}
...
Mais l'accès à l'oxygène rendu difficile par les hauteurs élevées du niveau de la nappe est prépondérant.
...
\subsection{Facteurs contrôlant les flux à l'échelle de la colonne de tourbe/de l'écosystème}
...
La modélisation de ce flux se fait donc généralement en utilisant la température que se soit celle de l'air \citep{bortoluzzi2006} ou celle du sol à différentes profondeurs : \SI{-5}{\centi\metre} \citep{gorres2014,ballantyne2014}, \SI{-10}{\centi\metre} \cite{kim1992,zhu2015}.
...
\subsubsection{le niveau de la nappe}
...
\subsubsection{température et niveau de nappe ?}
