...
%Ce travail sera focalisé sur ces écosystèmes
%, laissant de côté les tourbières tropicales dont le fonctionnement est spécifique.
%En \citep{chimner2005}.
...
%
%Différentes classifications des tourbières à sphaignes existent, elles diffèrent la thématique d'étude prioritaire (l'hydrologie, la topographie, la végétation \dots).
%Une classification simple et largement utilisée dans la littérature distingue deux catégories les tourbières dite hautes, ou de haut-marais \textit{bog}, et les tourbières basses, ou de bas-marais \textit{fen}.
...
Ces deux catégories doivent davantage être vu comme un continuum plutôt qu'une séparation franche.
...
Elles sont riches en nutriments (notamment en azote et phosphore) et le pH de leur eaux de surface varie de 4 à 8.
...
Ce sont des espèces dite ingénieures, capables de modifier l'environnement dans lequel elles se développent dans le but d'obtenir un avantage compétitif sur les autres végétaux \citep{vanbreemen1995}.
...
Elles ont également la capacité de stocker ces nutriments ce qui diminue encore ceux qui seront disponible dans le milieu \citep{rydin2013d}.
...
Ces contraintes (pauvreté en nutriments et acidité) défavorise l'implantation d'espèces peu tolérantes.
...
Parmi les plus répandues des graminoïdes (\textit{Eriophorum} spp., \textit{Scirpus cespitosus}, \textit{Rynchospora alba}, \textit{Carex} spp.) des arbustes (\textit{Erica tetralix}, \textit{Calluna vulgaris}, \textit{Andromeda polifolia}, \textit{Vaccinium} spp.) et bien d'autres encore 
 ...
 : des Carex (\textit{lasiocarpa}, \textit{rostrata}) des herbacées (\textit{Molinia caerulea}) des Phragmites (\textit{Phragmites australis}) Joncs (\textit{Juncus bulbosus}) et d'autres \citep{rydin2013dolip}
...
Cette partie décrit dans un premier temps les relations entre les GES (\coo et \chh) et les tourbières, puis les facteurs qui contrôlent ces flux dans ces écosystèmes et enfin les bilans de carbone qui ont pu y être estimé.
...
L'importance de ces processus varient selon l'échelle de temps considérée.
...
Si la photosynthèse est le processus majeur d'assimilation du \coo \footnote{Il existe d'autres voies métaboliques permettant la capture du \coo de l'atmosphère.\index{photosynthèse}
...
\citet{gornall2011} montrent que les effets des bryophytes sur le développement des plantes vasculaires sont en partie positifs et en partie négatifs ; les effets négatifs étant de plus en plus prépondérant quand l'épaisseur de la strate muscinale augmente.
...
Quand ils ne peuvent pas être mesurés à haute fréquence avec des analyseurs automatiques, que se soit à l'aide de tour Eddy-covariance ou de chambres, les flux sont estimés à partir de mesures manuelles.
La respiration est généralement estimée en reliant les flux à la température que se soit celle de l'air \citep{bortoluzzi2006a} ou celle du sol à différentes profondeurs : à \SI{-5}{\centi\metre} \citep{gorres2014,ballantyne2014}, ou à \SI{-10}{\centi\metre} \citep{kim1992,zhu2015}.
Différentes équations reliant la respiration à la température sont utilisées, mais la fonction exponentielle reste la plus largement utilisée \citep{fang2001}.
Le niveau de la nappe est parfois pris en compte \citep{strack2013,munir2015}, et plus rarement la végétation \citep{bortoluzzi2006a,karki2015}.
