...
Matières composées des éléments C, H, O, N, S et présentant des liaisons C, H. Elles sont composées de nombreux éléments dont des carbohydrates (sucres, cellulose \dots), des composés azotés (protéines, acides aminés \dots) et phénoliques (lignine \dots), des lipides (cires, résines, \dots) et d'autres.
...
Plus de \SI{85}{\percent} d'entre elles sont situés dans l'hémisphère nord, majoritairement dans les zones boréales et sub-boréales \cite{strack2008} (Figure~\ref{fig:peatlandGlobalDistribution}).
