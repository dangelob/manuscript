...
Comme nous l'avons, le stock de C accumulé par les tourbières s'est majoritairement constitué pendant l'Holocène.
...
\end{aligned} $$
Ce flux est généralement appelé \textbf{Production Primaire Brute} (PPB), \textit{Gross Primary Production}, (\textit{GPP}) en anglais.
...
Une fois assimilé le carbone est stocké principalement à travers la partie non décomposée des litières végétales.
...
Le \coo est émis dans l'atmosphère à travers différents processus.
Ces sources principales sont la respiration de la flore qu'elle soit aérienne ou souterraine, ce qu'on appelle la respiration autotrophe et la respiration microbienne que l'on appelle la respiration hétérotrophe.\index{respiration}
